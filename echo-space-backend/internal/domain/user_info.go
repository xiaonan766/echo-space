...
type UserInfo struct {
	...
	ShopCabinetVisible int        `gorm:"column:shop_cabinet_visible;type:tinyint;not null;default:0" json:"shopCabinetVisible"`
}
...
type UserHomeInfo struct {
	...
	ShopCabinetVisible bool   `json:"shopCabinetVisible"`
}
